<template>
  <div id="navigation">
    <div>
    <div class="navback">
      <img src="../src/assets/resLogo.png" class="logoSize" > 
    ...
    <div class="navC" id="ON">
      ...
      <div class="nav2">
        <div class="nav2_nav">
          <router-link to="/seoul">오작교는 ?</router-link>
          <router-link to="/seoul">팀소개 </router-link>
          <router-link to="/seoul">Home </router-link>
        </div>
      </div>
    </div>
  </div>
